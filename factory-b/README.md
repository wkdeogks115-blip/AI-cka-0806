...
- GitHub path scope: every changed path in a `factory-b-*` candidate PR must be under `factory-b/**` or `.github/workflows/factory-b-candidate.yml`; any other path fails CI.
